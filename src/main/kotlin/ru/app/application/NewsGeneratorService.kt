...
//    }
    ...
    fun startGenerationWithDelay() {
        Mono.delay(Duration.ofSeconds(5))
            ...
            .doOnSuccess { saved -> println("Generated one delayed news with id=${saved.id}") }
            .doOnError { e -> println("Error during delayed news generation: ${e.message}") }
            .subscribe()
    }
